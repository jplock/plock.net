---
title: AWS multi-account automation utopia
date: "2021-06-06T00:00:00Z"
---

This post was reposted from

=> https://www.linkedin.com/pulse/aws-multi-account-automation-utopia-justin-plock/ AWS multi-account automation utopia (LinkedIn)

Earlier this year, an excellent

=> https://docs.aws.amazon.com/whitepapers/latest/organizing-your-aws-environment/organizing-your-aws-environment.html whitepaper
...
=> https://github.com/smoketurner/sam-organization-setup sam-organization-setup (GitHub)
...
* AWS Organizations
=> https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_enable-disable.html enables all policy types
=> https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_org_support-all-features.html enables AWS service access

* AWS Service Catalog
=> https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-servicecatalog.html enables AWS Organizations access

* AWS Resource Access Manager
=> https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-ram.html enables organizational sharing

* AWS Identity & Access Management
=> https://aws.amazon.com/blogs/aws/new-use-aws-iam-access-analyzer-in-aws-organizations/ creates an organizational IAM access analyzer in the Control Tower "Audit" account

* AWS Firewall Manager
=> https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-fms.html delegates administration to the Control Tower "Audit" account

* Amazon GuardDuty
=> https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-guardduty.html in each region, delegates administration to the Control Tower "Audit" account and enables organizational access

* AWS SecurityHub
=> https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-securityhub.html in each region, delegates administration to the Control Tower "Audit" account and enables organizational access

* Amazon Macie
=> https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-macie.html in each region, delegates administration to the Control Tower "Audit" account and enables organizational access

* AWS Audit Manager
=> https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-audit-manager.html in each region, delegates administration to the Control Tower "Audit" account
...
=> https://github.com/smoketurner/sam-account-setup sam-account-setup (GitHub)
...
=> https://aws.amazon.com/solutions/implementations/customizations-for-aws-control-tower/ Customizations for AWS Control Tower (AWS Solutions Implementation)
=> https://aws.amazon.com/blogs/mt/customizing-account-configuration-aws-control-tower-lifecycle-events/ Customizing account configuration with AWS Control Tower lifecycle events (AWS Management & Governance Blog)
=> https://aws.amazon.com/blogs/mt/self-service-vpcs-in-aws-control-tower-using-aws-service-catalog/ Self-service VPCs in AWS Control Tower using AWS Service Catalog (AWS Management & Governance Blog)
